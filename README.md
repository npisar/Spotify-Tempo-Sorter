...
# Setup
For the program to work, you'll need 2 values that you should paste into [commands.txt](main/commands.txt)
...
Once you choose a name and description, copy and paste the Client ID and Client Secret into [commands.txt](main/commands.txt)
